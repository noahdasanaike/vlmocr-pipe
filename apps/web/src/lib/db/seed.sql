...
INSERT OR IGNORE INTO eval_models (id, provider_id, name, api_model_id, cost_per_image_credits, config) VALUES
  ...
  ('m2', 'p6', 'Gemini 3.1 Pro', 'gemini-3.1-pro-preview', 2, '{"reasoning_effort":"low"}'),
  ('m3', 'p6', 'Gemini 3 Flash', 'gemini-3-flash-preview', 1, '{"reasoning_effort":"low"}'),
  ...
  ('m18', 'p6', 'Gemini 2.5 Flash-Lite', 'gemini-2.5-flash-lite', 0.5, '{}'),
  ('m20', 'p1', 'ERNIE 4.5 VL 424B', 'baidu/ernie-4.5-vl-424b-a47b', 2, '{}'),
  ('m23', 'p6', 'Gemini 3.1 Flash Lite', 'gemini-3.1-flash-lite-preview', 0.5, '{}'),
  ...
  ('m30', 'p6', 'Gemini 2.5 Flash', 'gemini-2.5-flash', 1, '{}'),
  ('m31', 'p6', 'Gemini 2.5 Pro', 'gemini-2.5-pro', 2, '{}'),
  ...
  ('m38', 'p1', 'Gemma 3 12B', 'google/gemma-3-12b-it', 0.5, '{}'),
